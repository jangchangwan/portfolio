      ...
      <Grid container sx={{ marginTop: "2rem" }}>
        ...
        <Grid item xs={12} sm={12} md={6}>
          <Content>
            ...
            도움이 되지 않을까? 라는 생각으로 시작하게되었습니다. 이다.
          </Content>
          <Content>
            <Important>
              키움증권 API, FinanceDataReader 라이브러리, 네이버증권 크롤링
            </Important>
            을 통해 데이터를 수집하였고, 많은 주식 데이터를 분석을 하다보니
            검색하는 그 순간순간 분석하는 것보다는 주식시장 마감시간에 맞춰{" "}
          ...
          <ContentBox>
            ...
            <ContentTag2>
              관련 기업 데이터와 예측값 시각화, 회원가입 및 로그인 구현,
              검색기능 , 게시판 CRUD
            </ContentTag2>
          </ContentBox>
          <ContentBox>
          ...
          <ContentBox>
            ...
            <ContentTag2>React, javaScript</ContentTag2>
          </ContentBox>
          <ContentBox>
            <DoneOutlineIcon sx={{ marginRight: "0.5rem" }} />
            <ContentTag>BackEnd</ContentTag>
            <ContentTag2>SpringBoot, Flask</ContentTag2>
          </ContentBox>
          <ContentBox>
            <DoneOutlineIcon sx={{ marginRight: "0.5rem" }} />
            <ContentTag>DataBase</ContentTag>
            <ContentTag2>MySQL, MongoDB</ContentTag2>
          </ContentBox>
          <ContentBox>
            <DoneOutlineIcon sx={{ marginRight: "0.5rem" }} />
            <ContentTag>BigData</ContentTag>
            <ContentTag2>Keras, Numpy, Pandas</ContentTag2>
          </ContentBox>
        </Grid>
      </Grid>
    </Container>
